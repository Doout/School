...
public class Timer {
		...
		public long getRemaining() {
				if (isRunning()) { return (end - System.currentTimeMillis()); }
				return 0;
		}
		...
		/**
		 * Restarts this timer with a random time where it period is the max value.
		 */
		public void resetRandom() {
				this.end = System.currentTimeMillis() + ((int) (Math.random()*period));
		}
